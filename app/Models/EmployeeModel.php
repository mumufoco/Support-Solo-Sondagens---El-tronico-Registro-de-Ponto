 ...
 * Substitui o EmployeeModel com dados mockados para testes sem banco de dados
 */
...
/**
 * EmployeeModel Mockado para testes
 */
class EmployeeModel extends Model
{
    ...
    {
        log_message('debug', '[MOCK EmployeeModel] first() called');
        return !empty($this->mockUsers) ? (object) $this->mockUsers[0] : null;
    }

    public function verifyPassword(string $password, string $hash): bool
    {
        log_message('debug', '[MOCK EmployeeModel] verifyPassword called');
        return password_verify($password, $hash);
    }
}

// Avisar que estamos usando mock
log_message('info', '🎭 [MOCK] EmployeeModel mockado carregado com sucesso!');
