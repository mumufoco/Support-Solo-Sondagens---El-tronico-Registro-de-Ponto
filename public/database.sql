...
CREATE TABLE `audit_logs` (
  ...
  `event` varchar(100) NOT NULL COMMENT 'Tipo de evento',
  `auditable_type` varchar(100) DEFAULT NULL COMMENT 'Tipo de entidade',
  `auditable_id` int(11) UNSIGNED DEFAULT NULL COMMENT 'ID da entidade',
